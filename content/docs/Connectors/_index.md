...
* **A Session method** that tries to import good cookies from the user's browser or the Webdriver's cookies. Optionally, a Driver launches temporarily to perform a login and closes once good cookies are available for the Session.
